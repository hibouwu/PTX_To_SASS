...
fn main() {
    ...
    cmake
        ...
        // prevents ninja from adding a "re-run cmake" self-check rule that
        // causes "build.ninja still dirty after 100 tries" on incremental builds
        .define("CMAKE_SUPPRESS_REGENERATION", "ON");
