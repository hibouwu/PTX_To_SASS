#!/usr/bin/env python3
"""Self-contained Thor experiment runtime for tcgen05.relinquish_alloc_permit.

This local copy serves only tcgen05.relinquish_alloc_permit; it deliberately has no dependency on
